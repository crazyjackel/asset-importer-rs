//! FBX `AnimationStack` — Assimp [`AnimationStack`](https://github.com/assimp/assimp/blob/master/code/AssetLib/FBX/FBXDocument.h).
...
impl TryFrom<OwnedObject> for AnimationStack {
    ...
    fn try_from(o: OwnedObject) -> Result<Self, Self::Error> {
        match fbx_object_tag(&o) {
            ...
            _ => Err(FbxTypeMismatch::wrong_object_kind(o, "AnimationStack")),
        }
    }
}
