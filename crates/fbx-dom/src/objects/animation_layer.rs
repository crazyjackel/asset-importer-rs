//! FBX `AnimationLayer` — Assimp [`AnimationLayer`](https://github.com/assimp/assimp/blob/master/code/AssetLib/FBX/FBXDocument.h).
...
impl TryFrom<OwnedObject> for AnimationLayer {
    ...
    fn try_from(o: OwnedObject) -> Result<Self, Self::Error> {
        match fbx_object_tag(&o) {
            ...
            _ => Err(FbxTypeMismatch::wrong_object_kind(o, "AnimationLayer".to_string())),
        }
    }
}
